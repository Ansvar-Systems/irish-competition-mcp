/**
 * SQLite database access layer for the CCPC (Irish Competition) MCP server.
 *
 * Schema:
 *   - decisions    — CCPC enforcement decisions (abuse of dominance, cartels, sector inquiries)
