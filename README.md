...
**Endpoint:** `https://mcp.ansvar.eu/irish-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add irish-competition-mcp --transport http https://mcp.ansvar.eu/irish-competition/mcp` |
...
```json
{
  "mcpServers": {
    "irish-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/irish-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/irish-competition-mcp
```
...
```json
{
  "mcpServers": {
    "irish-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/irish-competition-mcp"]
    }
  }
}
```
